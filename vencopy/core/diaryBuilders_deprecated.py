...
class TimeDiscretiser:
    def __init__(self, activities, dt, method: str):
        ...
        # splitEvents() method discretise()
        # isNeighbour(currentEvent, nextEvent) method 
        # shareEventInBin ()
        # shareBinFill() strategies on how to treat 
        self.identifySlots() # binsTouched (startTimes info + lenght of activity)
        # self.allocate()
