...
- :ref:`simulate different charging strategies (uncontrolled, controlled charging , V2G) for EV fleets <software/flexestimators>`
- :ref:`model different grid infrastructure options (home charging, work charging, ..) <software/gridmodellers>`
- :ref:`analyse charging behaviour based on socio-economic data and trip purpose <software/dataparsers>`
